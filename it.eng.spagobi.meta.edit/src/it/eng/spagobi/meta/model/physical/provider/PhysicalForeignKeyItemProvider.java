...
/**
 * This is the item provider adapter for a {@link it.eng.spagobi.meta.model.physical.PhysicalForeignKey} object. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PhysicalForeignKeyItemProvider extends ModelObjectItemProvider implements IEditingDomainItemProvider, IStructuredItemContentProvider,
	...
	/**
	 * This adds a property descriptor for the Source Name feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSourceNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__SOURCE_NAME, false, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Source Table feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSourceTablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__SOURCE_TABLE, false, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Source Columns feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addSourceColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__SOURCE_COLUMNS, false, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Destination Name feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDestinationNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__DESTINATION_NAME, false, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null,
				null));
	}

	/**
	 * This adds a property descriptor for the Destination Table feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDestinationTablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__DESTINATION_TABLE, false, false, true, null, null, null));
	}

	/**
	 * This adds a property descriptor for the Destination Columns feature. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	protected void addDestinationColumnsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__DESTINATION_COLUMNS, false, false, true, null, null, null));
	}
	...
	protected void addModelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				...
				PhysicalModelPackage.Literals.PHYSICAL_FOREIGN_KEY__MODEL, false, false, true, null, null, null));
	}
	...
	public Collection<?> getChildren(Object object) {
		...
		for (int i = 0; i < sourceColumns.size(); i++) {
			...
			foreignKeyItemProvider.setText("(" + foreignKey.getSourceTable().getName() + ") " + sourceColumnName + " -> ("
					+ foreignKey.getDestinationTable().getName() + ") " + destinationColumn);
	...
	/**
	 * This returns PhysicalForeignKey.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		/*
		 * String label = ((PhysicalForeignKey)object).getName(); return label == null || label.length() == 0 ? getString("_UI_PhysicalForeignKey_type") :
		 * getString("_UI_PhysicalForeignKey_type") + " " + label;
		 */
		String label = ((PhysicalForeignKey) object).getSourceName();
		return label == null || label.length() == 0 ? getString("_UI_PhysicalForeignKey_type") : label;
	}
