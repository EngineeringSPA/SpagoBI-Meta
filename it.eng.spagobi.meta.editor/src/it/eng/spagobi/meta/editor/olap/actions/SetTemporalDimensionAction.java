 ...
 * 
 */
public class SetTemporalDimensionAction extends AbstractSpagoBIModelAction {
	 ...
	 * @param selection
	 */
	public SetTemporalDimensionAction(IWorkbenchPart workbenchPart, ISelection selection) {
		super(CreateTemporalDimensionCommand.class, workbenchPart, selection);
