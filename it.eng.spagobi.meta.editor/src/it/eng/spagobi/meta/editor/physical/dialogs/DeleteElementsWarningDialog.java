 ...
 * 
 */
public class DeleteElementsWarningDialog extends ListDialog {

	public DeleteElementsWarningDialog(Collection<ModelObject> markedElements) {
		super(new Shell());
		this.setContentProvider(new ArrayContentProvider());
		this.setTitle("Warning");
		this.setMessage("You must delete the followings physical objects before proceeding.\nPress OK to automatically delete them otherwise press CANCEL");
