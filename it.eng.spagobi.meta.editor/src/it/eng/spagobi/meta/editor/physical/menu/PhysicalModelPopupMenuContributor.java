 ...
 *
 */
public class PhysicalModelPopupMenuContributor {
	...
	public PhysicalModelPopupMenuContributor() {
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		actions = PhysicalModelMenuActionFactory.getActions(activeEditorPart, newChildDescriptors, selection);
