...
/**
 * This is the action bar contributor for the PhysicalModel model editor. <!-- begin-user-doc --> <!-- end-user-doc -->
 * 
 * @generated
 */
public class PhysicalModelEditorWorkbenchContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(RL.getString("_UI_ShowPropertiesView_menu_item")) {
		@Override
		public void run() {
			try {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(RL.getString("_UI_RefreshViewer_menu_item")) {
		@Override
	...
	/**
	 * This will contain one {@link org.eclipse.emf.edit.ui.action.CreateChildAction} corresponding to each descriptor generated for the current selection by
	...
	/**
	 * This implements {@link org.eclipse.jface.viewers.ISelectionChangedListener}, handling {@link org.eclipse.jface.viewers.SelectionChangedEvent}s by
	 * querying for the children and siblings that can be added to the selected object and updating the menus accordingly. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 */
	@Override
	...
	/**
	 * This generates a {@link org.eclipse.emf.edit.ui.action.CreateChildAction} for each object in <code>descriptors</code>, and returns the collection of
	...
	public void menuAboutToShow(IMenuManager menuManager) {
		...
		/*
		 * Commented by MC MenuManager submenuManager = null;
		 * 
		 * 
		 * submenuManager = new MenuManager(RL.getString("_UI_CreateChild_menu_item")); populateManager(submenuManager, createChildActions, null);
		 * menuManager.insertBefore("edit", submenuManager);
		 * 
		 * submenuManager = new MenuManager(RL.getString("_UI_CreateSibling_menu_item")); populateManager(submenuManager, createSiblingActions, null);
		 * menuManager.insertBefore("edit", submenuManager);
		 */
	}
	...
	protected void addGlobalActions(IMenuManager menuManager) {
		/*
		 * menuManager.insertAfter("additions-end", new Separator("ui-actions")); menuManager.insertAfter("ui-actions", showPropertiesViewAction);
		 * 
	...
	protected DeleteAction createDeleteAction() {
		return new DeletePhysicalModelObjectAction(removeAllReferencesOnDelete());
	}
